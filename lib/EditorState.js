...
var EditorState = function () {
  ...
  EditorState.set = function set(editorState, put) {
    var map = editorState.getImmutable().withMutations(function (state) {
      ...
      if (newContent !== existingContent) {
        state.set('treeMap', regenerateTreeForNewBlocks(editorState, newContent.getBlockMap(), newContent.getEntityMap(), newContent.getMetaMap(), decorator));
      }
  ...
  EditorState.prototype.getCurrentMeta = function getCurrentMeta() {
    var override = this.getInlineStyleOverride();
    if (override != null) {
      return override;
    }
 ...
 */
function regenerateTreeForNewBlocks(editorState, newBlockMap, newEntityMap, newMetaMap, decorator) {
  var contentState = editorState.getCurrentContent().set('entityMap', newEntityMap).set('metaMap', newMetaMap);
...
function getMetaForCollapsedSelection(content, selection) {
  var startKey = selection.getStartKey();
  var startOffset = selection.getStartOffset();
  var startBlock = content.getBlockForKey(startKey);
...
function getMetaForNonCollapsedSelection(content, selection) {
  var startKey = selection.getStartKey();
  var startOffset = selection.getStartOffset();
  var startBlock = content.getBlockForKey(startKey);
...
function lookUpwardForMeta(content, fromKey) {
  var previousBlock = content.getBlockBefore(fromKey);
  var previousLength;
