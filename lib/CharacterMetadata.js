...
var CharacterMetadata = function (_CharacterMetadataRec) {
  ...
  CharacterMetadata.prototype.getStyleMeta = function getStyleMeta(style) {
    return this.get('meta').get(style);
  };

  CharacterMetadata.prototype.getMeta = function getMeta() {
  ...
  CharacterMetadata.applyStyle = function applyStyle(record, style, metaKey) {
  ...
  CharacterMetadata.create = function create(config) {
    ...
    var defaultConfig = { style: EMPTY_SET, meta: EMPTY_MAP, entity: null };
