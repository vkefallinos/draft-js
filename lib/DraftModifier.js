...
var DraftModifier = {
  ...
  replaceText: function replaceText(contentState, rangeToReplace, text, inlineStyle, entityKey) {
    contentState = addOperationToContentState(contentState, "replaceText", [].concat(Array.prototype.slice.call(arguments)));
  ...
  moveBlock: function moveBlock(contentState, atomicBlock, targetBlock, insertionMode) {
    contentState = addOperationToContentState(contentState, "moveBlock", [].concat(Array.prototype.slice.call(arguments)));
  ...
  replaceWithFragment: function replaceWithFragment(contentState, targetRange, fragment) {
    ...
    contentState = addOperationToContentState(contentState, "replaceWithFragment", [].concat(Array.prototype.slice.call(arguments), [fragment]));
  ...
  removeRange: function removeRange(contentState, rangeToRemove, removalDirection) {
    ...
    contentState = addOperationToContentState(contentState, "removeRange", [].concat(Array.prototype.slice.call(arguments)));
  ...
  splitBlock: function splitBlock(contentState, selectionState, keyBelow) {
    ...
    contentState = addOperationToContentState(contentState, "splitBlock", [].concat(Array.prototype.slice.call(arguments), [keyBelow]));
  ...
  applyInlineStyle: function applyInlineStyle(contentState, selectionState, inlineStyle) {
    contentState = addOperationToContentState(contentState, "applyInlineStyle", [].concat(Array.prototype.slice.call(arguments)));
    return ContentStateInlineStyle.add(contentState, selectionState, inlineStyle);
  },

  removeInlineStyle: function removeInlineStyle(contentState, selectionState, inlineStyle) {
    contentState = addOperationToContentState(contentState, "removeInlineStyle", [].concat(Array.prototype.slice.call(arguments)));
  ...
  setBlockType: function setBlockType(contentState, selectionState, blockType) {
    contentState = addOperationToContentState(contentState, "setBlockType", [].concat(Array.prototype.slice.call(arguments)));
  ...
  setBlockData: function setBlockData(contentState, selectionState, blockData) {
    contentState = addOperationToContentState(contentState, "setBlockData", [].concat(Array.prototype.slice.call(arguments)));
  ...
  mergeBlockData: function mergeBlockData(contentState, selectionState, blockData) {
    contentState = addOperationToContentState(contentState, "mergeBlockData", [].concat(Array.prototype.slice.call(arguments)));
  ...
  adjustBlockDepth: function adjustBlockDepth(contentState, selectionState, adjustment, maxDepth) {
    contentState = addOperationToContentState(contentState, "adjustBlockDepth", [].concat(Array.prototype.slice.call(arguments)));
  ...
  replaceEntityData: function replaceEntityData(contentState, key, newData) {
    contentState = addOperationToContentState(contentState, "replaceEntityData", [].concat(Array.prototype.slice.call(arguments)));
  ...
  createEntity: function createEntity(contentState, type, mutability, data, key) {
    ...
    contentState = addOperationToContentState(contentState, "createEntity", [].concat(Array.prototype.slice.call(arguments), [key]));
  ...
  addEntity: function addEntity(contentState, instance, key) {
    ...
    contentState = addOperationToContentState(contentState, "addEntity", [].concat(Array.prototype.slice.call(arguments), [key]));
    return addEntityToContentState(contentState, instance, key);
  },

  applyEntity: function applyEntity(contentState, selectionState, entityKey) {
    contentState = addOperationToContentState(contentState, "applyEntity", [].concat(Array.prototype.slice.call(arguments)));
    var withoutEntities = removeEntitiesAtEdges(contentState, selectionState);
