...
var DraftModifier = {
  ...
  replaceWithFragment: function replaceWithFragment(contentState, targetRange, fragment) {
    ...
    if (contentState.isOTEnabled()) contentState = addOperationToContentState(contentState, "replaceWithFragment", [].concat(Array.prototype.slice.call(arguments), [fragment]));
